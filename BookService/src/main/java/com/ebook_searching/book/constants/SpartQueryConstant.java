package com.ebook_searching.book.constants;
...
public class SpartQueryConstant {
    ...
    public static String GET_OBJECTPROPERTIES_BETWEEN_CLASSES(List<String> objectProperties) {
        ...
        return "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>\n" +
                ...
                "  FILTER (STRSTARTS(STR(?property), \"http://www.example.org/ebook#\") &&\n" +
                "          STRSTARTS(STR(?domain), \"http://www.example.org/ebook#\")\n" +
                "&&\n" +
                "          STRSTARTS(STR(?range), \"http://www.example.org/ebook#\")\n" +
                " &&\n" +
                "    (\n" +
                valuesPart.toString() +
                "\n" +
