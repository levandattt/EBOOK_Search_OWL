...
@Component
public class V7_AddLabelsForAuthors implements MigrationManager.Migration {
    ...
    public void up() {
        ...
        authorClass.addProperty(RDFS.label, model.createLiteral("who", "en"));
