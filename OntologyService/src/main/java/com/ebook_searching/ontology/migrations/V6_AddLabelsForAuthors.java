...
@Component
public class V6_AddLabelsForAuthors implements MigrationManager.Migration {
    ...
    public void up() {
        ...
        authorClass.addProperty(RDFS.label, model.createLiteral("Authors of", "en"));
        authorClass.addProperty(RDFS.label, model.createLiteral("Author of", "en"));
